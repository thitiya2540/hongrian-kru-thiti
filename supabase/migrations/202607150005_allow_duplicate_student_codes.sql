-- ห้องเรียนครูธิติ · Allow duplicate student codes for teacher-managed scoring.
-- Student identity is the internal UUID. Student codes are display/search fields.
...
comment on column public.students.student_code is 'รหัสนักเรียนสำหรับแสดงผล/ค้นหา อนุญาตให้ซ้ำได้ ตัวตนจริงของนักเรียนคือ id';
