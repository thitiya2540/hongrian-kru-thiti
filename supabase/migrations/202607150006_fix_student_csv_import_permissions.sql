-- ห้องเรียนครูธิติ · Fix CSV import transaction permissions.
-- The RPC writes students, classroom links, and activity logs as one transaction.
-- It still checks the active authenticated user before touching classroom data.
